...
## Fall 2026 · Section 002 · CRN 23266
### Jake Jabs College of Business & Entrepreneurship · Montana State University–Bozeman

| | |
| --- | --- |
| **Meets** | Tuesday & Thursday, 12:15 – 1:30 pm · JABS 215 |
| **Term** | Aug 27 – Dec 17, 2026 · 3 credits · traditional letter grade |
| **Instructor** | Xuying W. Swift · xuying.swift@montana.edu |
| **Office hours** | *TBD — posted on Canvas in week 1* |
| **Platforms** | **Canvas** (syllabus, slides, data, project submissions, grades) · **Cengage MindTap** (quizzes and chapter assignments) |

> **Check your MSU email daily.** All official course correspondence goes to your university address. Set your spam filter to allow the course listserv.

---

## Course Description

This course enables students to understand basic statistical concepts and techniques and how modern managers apply them in business. Emphasis is on statistical reasoning, problem-solving, computer applications, and interpretation of results.

The through-line is one question asked in progressively harder forms: **what can I responsibly conclude from imperfect data?** We describe data, then reason from a sample to a population, then test claims, then model relationships among several variables.
...
> **Note on objective 4.** The *Essentials* edition has no statistical process control chapter — SPC appears only in the unabridged *Modern Business Statistics*. No session is allocated to it. If it is assessed this term, a short introduction will be posted to Canvas and announced in class; otherwise objectives 1–3 and 5–8 are the graded set.

## Materials

**Cengage MindTap — required.** All quizzes and chapter assignments are completed in MindTap, linked from Canvas. Your MindTap access includes the **eBook**, so no separate textbook purchase is necessary. Get access in week 1; missed deadlines caused by a late purchase are not excused.

**Textbook.** Camm, Cochran, Fry, Ohlmann, Anderson, Sweeney & Williams, *Essentials of Modern Business Statistics with Microsoft Excel*, 9th edition (Cengage, 2025). ISBN 978-0-357-93004-5. A print copy is optional. **This is a new textbook this year** — chapter numbering does not match older editions or older notes. Use the section numbers in the schedule below.

**Technology.**

- **Microsoft Excel, desktop version**, with the **Analysis ToolPak** enabled. Free through MSU's Microsoft 365. The browser version will *not* run tools we depend on. We set this up together in session 2.
- A **laptop** in class on days marked **Lab**. If a laptop is a problem, tell me in week 1 and we will solve it quietly.
- A **backup** of your work. A lost workbook is not an extension.

## How the Course Runs

Tuesdays introduce a method — where it comes from, what it assumes, what it is for. Thursdays continue it and put it to work in Excel. **MindTap** work for each chapter is due at **11:59 pm MT** on the date shown in the schedule. **Projects** are due at the start of class on the date shown, submitted on Canvas.

We do not cover all fifteen chapters. See the note after the schedule for what is omitted and why.
...
**Peer evaluation.** Every member submits a confidential evaluation of teammates' contributions, which can adjust an individual score by up to **±10%**. A member who does not contribute does not receive the team's grade.

#### Final Project Presentation · 100 points

**12 minutes, plus 3 minutes of questions. Every member speaks.** Slides are uploaded to Canvas by 11:59 pm MT the night before your team presents; you present from the posted file, so nothing is edited between upload and delivery.

Teams present in one of two rounds — **Thu, Dec 10** in class, or during the **final exam period, Dec 14–17**. Rounds are assigned by random draw announced Dec 1. Both rounds are required attendance for everyone: you are an audience member on the day you are not presenting, and audience participation counts toward the delivery score.

| | Points |
| --- | --- |
| The question — what you asked and why a decision-maker should care | 15 |
| Method — what you did and why it was the right choice for this question | 25 |
| Findings — your results, including the regression, read correctly | 30 |
| Limitations — what your data and model cannot tell you, stated plainly | 15 |
| Delivery — timing, legible slides, every member contributing, questions handled | 15 |

Because the report is due Dec 8, your analysis is finished before anyone presents. The presentation is not new work; it is the argument you already wrote, made in twelve minutes to people who have not read it. That translation is the skill being graded.
...
| # | Date | Topic | Read | Due |
| --- | --- | --- | --- | --- |
| 8 | Tue, Sep 22 | **The normal distribution** — the normal and standard normal curves, *z*, and probability as area · **Lab:** `NORM.DIST`, `NORM.INV`, `NORM.S.INV` | §6.2 |  |
...
| — | Dec 14–17 | **FINAL PROJECT PRESENTATIONS** — round 2; day and time per the Registrar's final exam schedule |  |  |
...
| Wed, Sep 16 | Last day to drop via advisor without a "W" |
| Oct 27 – Nov 17 | Priority registration for Spring 2027 |
| Wed, Nov 18 | **Last day to drop with a "W" via advisor** |
| Nov 23–27 | Fall Break — no classes |
...
**Attendance.** Expected, not separately graded, and close to determinative — this course moves in chapter order and each chapter leans on the one before it. If you miss a session, get the material from a classmate and from Canvas *before* office hours, so we can spend that time on what you actually do not understand.

**Devices.** Laptops required on lab days, welcome otherwise. Phones away during exams.
...
**Incomplete grades.** An "I" is available only when a documented emergency prevents you from finishing a small remaining portion of the course and your work to that point is passing. It is not an alternative to withdrawing.

**Academic integrity.** **All work is individual except the Final Project.** Students must abide by the Student Conduct Code and Academic Integrity Guidelines at [montana.edu/policy/student_conduct](https://www.montana.edu/policy/student_conduct/). Paraphrasing or quoting another's work without citation is misconduct, as is relying heavily on unacknowledged source material. Do not share your files or accept files from others; work is checked for plagiarism. Sharing files or cheating on a quiz results in a zero on that work or in the class and a report to the Dean. Within a Final Project team, collaboration is expected and shared files are the point; across teams the rule is unchanged. Copying a workbook, fabricating or altering data, and misreporting results are all violations — the last one especially, because it is the specific dishonesty this discipline exists to prevent.

**Generative AI.** AI tools are **permitted for learning** and **not permitted for producing submitted work**.

- *Permitted:* explaining a concept, decoding an Excel error, asking what a *p*-value means, debugging a formula you wrote.
- *Not permitted:* generating your analysis, writing your interpretation, drafting your report, or answering a quiz or exam question.

Every project requires a short **disclosure** of what you used AI for, and you must be able to **explain, in your own words and on request, every number and sentence you submit.** I do ask. Undisclosed AI-generated work is handled as academic misconduct. The reason is not suspicion: the skill this course certifies is judging whether output is trustworthy, and that is exactly the skill you lose by letting a model produce output unexamined.

**Disability accommodations.** If you have a documented disability for which you may request accommodations, tell me as soon as possible and contact **MSU Disability Services** (Romney Hall · 406-994-2824 · drv@montana.edu · [montana.edu/disabilityservices](https://www.montana.edu/disabilityservices/)). Accommodations cannot be applied retroactively to submitted work. If you suspect you need accommodations but have never been assessed, Disability Services can advise you.

**Mental health and wellness.** Your mental health matters as much as your physical health, and it is OK to experience difficulty. Please use these, and tell me if something is affecting your work — no details needed.
...
**Title IX.** MSU prohibits discrimination and harassment, including sexual misconduct. As an instructor I am a **mandatory reporter** and must report disclosures of sexual misconduct to the Title IX Coordinator. For a confidential conversation instead, contact the **VOICE Center** (406-994-7069, 24/7) or Counseling & Psychological Services.

**Basic needs.** If affording food or securing housing is a problem, MSU has resources including the student food pantry, and the Dean of Students office can help you navigate them. Tell me if it is affecting your coursework and I will help, confidentially.

**Name and pronouns.** Tell me the name and pronouns you want used in class, whatever appears on my roster.

**Veterans and service members.** Let me know so I can support you around drill weekends, deployments, and VA appointments.

**Copyright and recording.** This syllabus and all course materials are protected by U.S. copyright law. You may use them for your own study, but reproducing, selling, or distributing them is prohibited — **including posting to Chegg, CourseHero, or similar platforms** — and may violate copyright law and the Code of Student Conduct. Recording class requires my permission, and distributing a recording is prohibited. Students with recording accommodations authorized by Disability Services do not need permission but must notify me before recording.

**Communication.** Email is the official channel. Use your MSU address, put **BMGT 240IS** in the subject line, write in complete sentences with a salutation and a signature block (name, course, section), and be concise — I aim to respond within one business day on weekdays. This is a business course and email is a business skill. Please do not ask for what the syllabus already answers, and do not email about a specific grade — that conversation happens in office hours.

**Grade concerns.** Email me within **one week** of receiving a grade with the specific item and the specific reason. Later disputes go through the department's grade appeal process. Grades are protected under FERPA and posted only in Canvas.

**Changes.** I may adjust the schedule if the class needs more time on something; changes are announced in class and posted on Canvas. Grade weights and exam dates will not change except in an emergency.

---

## How to Do Well

Statistics is learned by doing it, not by watching it. Read ahead — twenty minutes with the chapter before class changes what the lecture is for. Treat surprise as information: when a result contradicts what you expected, that gap is the most valuable thing in the room, so bring it to class. And ask what a number *means*, not just how to compute it. By December you will produce a regression output in forty seconds; the whole game is what you say next.

I am here to help you learn, but you are ultimately responsible for your performance.

---

*BMGT 240IS · Business Analytics · Fall 2026 · Section 002 · Xuying W. Swift · Montana State University–Bozeman. Textbook: Camm et al., Essentials of Modern Business Statistics with Microsoft Excel, 9e. Subject to change; changes announced in class and posted on Canvas.*
